...
def compiler():
    #compile program
    cmd = CC+" "+compilation_flags+"main.c -I./AVI -c"
    ret = subprocess.call(cmd,shell=True)
    if(ret != 0):
        print "Error compile"
        sys.exit(1)

    cmd = CC+" "+compilation_flags+"main.o ./AVI/avimod.o ./AVI/avilib.o -o "+kernel_exec+" -lm"
    ret = subprocess.call(cmd,shell=True)
    if(ret != 0):
        print "Error compile"
        sys.exit(1)
...
kernel_args = "test.avi 30"
CC = "icc"

out_file = "results/base_heartwall_30.csv"
