...
def compiler():
	#compile program
	cmd = CC+" "+compilation_flags+f1+f2+f3+f4+f5+"needle.cpp -o "+kernel_exec+" -lm"
	...
	for affinity in ['scatter','balanced']:
		for cores in [19,38,57]:
			for threads in [2,3,4]:
				...
				kernel_args[2] = str(cores*threads)
...
kernel_exec = "needle"
kernel_args = ["22000","10",""]
CC = "icc"

out_file = "results/needle_22000.csv"
