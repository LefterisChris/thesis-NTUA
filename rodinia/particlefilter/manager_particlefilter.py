...
def compiler():
	#compile program
	cmd = CC+" "+compilation_flags+f1+f2+f3+f4+f5+"ex_particle_OPENMP_seq.c -o "+kernel_exec
...
args = ["-x","512","-y","512","-z","10","-np","80000"]
CC = "icc"

out_file = "results/particle_filter_512_512_10_80000.csv"
