...
def compiler():
	#compile program
	cmd = CC+" "+compilation_flags+f1+f2+f3+f4+f5+"streamcluster_omp.cpp -o "+kernel_exec
...
kernel_exec = "streamcluster"
args = ["10", "20", "256", "32768", "32768	", "1000", "none", "output.txt",""]
CC = "icc"

out_file = "results/streamcluster.csv"
