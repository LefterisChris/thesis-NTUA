...
def compiler():
	#compile program
	cmd = CC+" "+compilation_flags+f1+f2+f3+f4+f5+"hotspot_openmp.cpp -o "+kernel_exec
...
kernel_exec = "hotspot"
args = ["1024", "1024", "200","1","temp_1024","power_1024","output.out"]
CC = "icc"

out_file = "results/hotspot_1024.csv"
