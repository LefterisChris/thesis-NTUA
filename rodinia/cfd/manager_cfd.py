...
def compiler():
    #compile program
    cmd = CC+" "+compilation_flags+f1+f2+f3+f4+f5+"euler3d_cpu.cpp -o "+kernel_exec
    ...
    for affinity in ['scatter','balanced']:
        for cores in [19,38,57]:
            for threads in [2,3,4]:
                ...
                kernel_args[0] = str(cores*threads)
...
kernel_exec = "euler3d_cpu"
kernel_args = ["","fvcorr.domn.097K"]
CC = "icc"

out_file = "results/euler3d_097K.csv"
