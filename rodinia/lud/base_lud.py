...
def compiler():
	#compile program
	cmd = CC+" "+compilation_flags+"-I./common/ lud.c -c"
	ret = subprocess.call(cmd,shell=True)
	if(ret != 0):
		print "Error compile"
		sys.exit(1)
	cmd = CC+" "+compilation_flags+"-I./common/ lud_omp.c -c"
	ret = subprocess.call(cmd,shell=True)
	if(ret != 0):
		print "Error compile"
		sys.exit(1)
	cmd = CC+" "+compilation_flags+"lud.o lud_omp.o ./common/common.o -o "+kernel_exec+" -lm"
	ret = subprocess.call(cmd,shell=True)
	if(ret != 0):
		print "Error compile"
		sys.exit(1)
...
out_file = "results/base_lud_2048.csv"
